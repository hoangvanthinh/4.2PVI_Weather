...
//    SES_Modbus.au16regs = regs;
    ...
    // check if there is any incoming frame
    u8current = UART3_RxDataAvailable();
    ...
    {
    case MB_FC_READ_COILS:
        return process_FC1( SES_42.Coils.REG, 32);
        break;
    case MB_FC_READ_DISCRETE_INPUT:     
        break;
    case MB_FC_READ_INPUT_REGISTER:
    ...
    case MB_FC_READ_HOLD_REGISTERS :
        ...
        break;
    case MB_FC_WRITE_COIL:
        return process_FC5( SES_42.Coils.REG, 32 );
        break;
    case MB_FC_WRITE_REGISTER :
        return process_FC6( regs, u8size );
        break;
...
static int8_t SES_Modbus_getRxBuffer(void)
{
    ...
    while ( UART3_RxDataAvailable() )
    {
        SES_Modbus.au8Buffer[ SES_Modbus.u8BufferSize ] = UART3_Read();
...
static void SES_Modbus_sendTxBuffer(void)
{
    ...
    //int s = 
    UART3_WriteBuffer( SES_Modbus.au8Buffer, SES_Modbus.u8BufferSize );
