...
//#define TCP_DELAYED_ACK_TIMEOUT     ((uint32_t)TICK_SECOND) // Timeout for delayed-acknowledgement algorithm
...
#define TCP_SYN_QUEUE_TIMEOUT     ((uint32_t)TICK_SECOND*30) // Timeout for when SYN queue entries are deleted if unserviceable
