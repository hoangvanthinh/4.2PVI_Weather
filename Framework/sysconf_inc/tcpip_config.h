 ...
 *   (デモボードの操作の様だぞっとぉ)
 */
#define MY_DEFAULT_HOST_NAME            "Interface"  // 15文字までの半角英数字
...
//#define MY_DEFAULT_MAC_BYTE5            (0x18)  // MACアドレスを使用したいと考えています。
//#define MY_DEFAULT_MAC_BYTE6            (0x10)  // 
#define MY_DEFAULT_MAC_BYTE1            (0x78)  // 00-04-A3-00-00-00のデフォルトを使用して下さい。
#define MY_DEFAULT_MAC_BYTE2            (0xC2)  // ENCX24J600、MRF24WB0Mを使用する場合、又は
#define MY_DEFAULT_MAC_BYTE3            (0xC0)  // PIC32MX6XX / 7XXの内部イーサネットの場合は、
#define MY_DEFAULT_MAC_BYTE4            (0x90)  // その代わりに工場内でプログラムされた
...
#define TCP_PURPOSE_MODBUS_CLIENT 13
...
const struct {
    ...
    {TCP_PURPOSE_MODBUS_CLIENT,TCP_ETH_RAM, 1000, 1000},
#endif
    
    
#if defined(STACK_USE_MODBUS_SERVER)
   {TCP_PURPOSE_MODBUS_TCP_SERVER,TCP_ETH_RAM, 500, 500},
#endif  
