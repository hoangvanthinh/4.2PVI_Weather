...
#define LED0_IO             (LATCbits.LATC8)
//#define LED1_TRIS           (TRISDbits.TRISD1)  // Ref D2
#define LED1_IO             (LATCbits.LATC9)
...
#define ENC_RST_TRIS		(TRISDbits.TRISD3)
#define ENC_RST_IO			(LATDbits.LATD3)

#define ENC_CS_TRIS			(TRISDbits.TRISD2)
#define ENC_CS_IO			(LATDbits.LATD2)

#define ENC_SCK_TRIS		(TRISFbits.TRISF0)

#define ENC_SDI_TRIS		(TRISDbits.TRISD13)
